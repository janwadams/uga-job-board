  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-red-800">📊 Admin Analytics Dashboard</h1>
        {/* CHANGED: Adjusted styling for button spacing */}
        <div className="flex space-x-4"> {/* Ensure flex is applied here */}
      ...
      {metrics && (
        <div className="space-y-8">
          ...
          <div className="bg-white p-6 rounded shadow">
            <h2 className="text-xl font-semibold text-gray-700 mb-4">Time-Series Counts</h2>
