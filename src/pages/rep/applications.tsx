// src/pages/rep/applications.tsx - company rep view to see applications for their jobs
...
export default function RepApplications() {
  ...
  // check if user is authorized company rep
  useEffect(() => {
  ...
  const fetchJobsAndApplications = async () => {
    ...
    try {
      // first get all jobs posted by this company rep
      const { data: jobs, error: jobsError } = await supabase
        .from('jobs')
        .select('*')
        .eq('created_by', session.user.id)  // using created_by field just like in rep dashboard
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">
            View and manage applications for your company's posted jobs
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-blue-500">
            ...
            <div className="text-xs text-gray-500 mt-1">Total jobs your company has posted</div>
          </div>
                            ...
                            <div key={application.id} className="p-4 hover:bg-gray-50">
                              <div className="flex justify-between items-start">
                                <div className="flex-1">
                                  ...
                                  {/* notes if exists (old field for legacy applications) */}
                                  {application.notes && (
                                  ...
                                  {/* show if missing contact info (legacy applications) */}
